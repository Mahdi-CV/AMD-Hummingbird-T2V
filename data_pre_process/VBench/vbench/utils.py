...
def load_dimension_info(json_dir, dimension, lang):
    ...
    # get prompt list
    with open('/group/ossdphi_algo_scratch_01/hecui102/codelib/helps/mcm/mcm/VBench/test_prompts.txt', 'r', encoding='utf-8') as file:
        lines = file.readlines()
    prompt_list = [line.strip() for line in lines]
    idx = 0
