...
class Image2Video():
    def __init__(self,result_dir='./tmp/',gpu_num=1,resolution='256_256') -> None:
        ...
        assert self.resolution[0] == 320 and self.resolution[1] == 512, f'{self.resolution[0], self.resolution[1]}'
        # self.download_model()
        ...
        ckpt_path = '/mnt/share/amdsharks/mengmege/models/dynamicrafter/512_interp/model.ckpt'
